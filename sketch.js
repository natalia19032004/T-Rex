...
function setup() {
  ...
  gameOver = createSprite(300,90,150,30);
  gameOver.addImage("gameover", gameover);
  gameOver.scale = 0.5;
  
  restartSprite = createSprite(280,120,150,30);
...
//ya estoy iniciando  
  ...
  // es la llave del Play
  // cuando el juego esta en End esta en 0 la velocidad
